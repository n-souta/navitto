...
このファイルは Navitto プラグインの完全なファイル構造を定義します。
...
│   │
│   ├── ai-skills/                               # Navitto専用 Agent Skills
│   │   └── skills/
...
│
├── includes/                                    # PHPクラス
│   ├── class-navitto.php                   # メインクラス（フロントエンド処理）
│   ├── class-navitto-admin.php             # 管理クラス（メタボックス/カスタマイザー）
│   ├── class-navitto-settings.php          # 設定ページクラス
│   └── class-navitto-detector.php          # 検出クラス（テーマ/TOCプラグイン検出）
│
├── assets/                                      # フロントエンドアセット
│   ├── css/
...
│   │   ├── test-class-navitto.php          # メインクラステスト
│   │   ├── test-class-navitto-admin.php    # 管理クラステスト
│   │   ├── test-class-navitto-settings.php # 設定クラステスト
│   │   └── test-class-navitto-detector.php # 検出クラステスト
│   │
...
│   ├── navitto-ja.po                       # 日本語翻訳（編集用）
│   └── navitto-ja.mo                       # 日本語翻訳（コンパイル済）
│
└── build/                                       # ビルド成果物（リリース用）
...
| `navitto.php` | プラグインヘッダー、クラス読込、フック登録 | 中 |
...
| ファイル | クラス名 | 役割 |
|---------|---------|------|
| `class-navitto.php` | ContentPilot | メインクラス（フロントエンド処理） |
| `class-navitto-admin.php` | Navitto_Admin | 管理画面（メタボックス/カスタマイザー） |
| `class-navitto-settings.php` | Navitto_Settings | 設定ページ |
| `class-navitto-detector.php` | Navitto_Detector | テーマ/TOCプラグイン検出 |
...
|---------|-----------|
| `bootstrap.php` | テストブートストラップ |
| `test-class-navitto.php` | `Navitto_Main` クラス |
| `test-class-navitto-admin.php` | `Navitto_Admin` クラス |
| `test-class-navitto-settings.php` | `Navitto_Settings` クラス |
| `test-class-navitto-detector.php` | `Navitto_Detector` クラス |
...
| `navitto-ja.po` | PO | 日本語翻訳（編集用） |
| `navitto-ja.mo` | MO | 日本語翻訳（コンパイル済） |
...
```
クラス: .navitto-class-name（BEM方式）
Block: .navitto-nav
Element: .navitto-nav__item
Modifier: .navitto-nav__item--active
```

### ファイル

```
PHPクラス: class-navitto-classname.php
PHPテスト: test-class-navitto-classname.php
JavaScript: navitto-filename.js
CSS: navitto-filename.css
```
